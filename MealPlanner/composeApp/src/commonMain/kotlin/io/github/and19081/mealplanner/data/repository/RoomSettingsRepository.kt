...
class RoomSettingsRepository(
  ...
  private val settingsFlow: StateFlow<AppSettingsEntity> =
      dao.observe()
  ...
  override val cornerStyle: StateFlow<CornerStyle> =
      settingsFlow
          .map { entity ->
            try {
              CornerStyle.valueOf(entity.cornerStyle)
            } catch (e: Exception) {
              CornerStyle.ROUNDED
            }
          }
  ...
  override val accentColor: StateFlow<AccentColor> =
      settingsFlow
          .map { entity ->
            try {
              AccentColor.valueOf(entity.accentColor)
            } catch (e: Exception) {
              AccentColor.GREEN
            }
          }

...
data class ShoppingReceiptDraft(
    ...
    val subtotalCents: Long get() = lineItems.sumOf { it.priceCents }
    val taxCents: Long get() = (subtotalCents * taxRatePercent / 100.0).toLong()
    val computedTotalCents: Long get() = subtotalCents + taxCents
    val hasDiscrepancy: Boolean
        get() = userEnteredTotalCents != null &&
                userEnteredTotalCents != computedTotalCents
}

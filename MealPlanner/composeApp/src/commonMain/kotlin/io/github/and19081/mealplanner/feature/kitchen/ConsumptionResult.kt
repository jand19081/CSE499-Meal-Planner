...
/**
 * Represents the outcome of a meal consumption confirmation. Mirrors the four MealSource variants —
 * each branch carries only the data that variant actually needs.
 */

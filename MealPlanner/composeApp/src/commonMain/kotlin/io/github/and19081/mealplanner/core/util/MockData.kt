  ...
  suspend fun initialize(
    ...
    fun createIng(id: Uuid, name: String, cat: Category, unit: UnitModel? = null): FoodItem {
      return Ingredient(
          ...
          purchasableInfo = PurchasableInfo(categoryId = cat.id, expectedPriceCents = 0),
      )
    }
    ...
    listOf(
            purchaseOption("00000000-0000-0000-0005-000000000001", iEggs, walmart, 956, 60.0, uEach),
            purchaseOption("00000000-0000-0000-0005-000000000002", iMilk, walmart, 437, 0.5, uGallon),
            purchaseOption("00000000-0000-0000-0005-000000000003", iRiceFlour, walmart, 300, 16.0, uOz),
            purchaseOption(
            ...
            purchaseOption("00000000-0000-0000-0005-000000000005", iButter, walmart, 697, 8.0, uEach),
            purchaseOption("00000000-0000-0000-0005-000000000006", iSausage, walmart, 397, 16.0, uOz),
            purchaseOption("00000000-0000-0000-0005-000000000007", iChicken, walmart, 1200, 48.0, uOz),
            purchaseOption("00000000-0000-0000-0005-000000000008", iCheese, walmart, 1724, 80.0, uOz),
            purchaseOption(
            ...
            purchaseOption("00000000-0000-0000-0005-000000000011", iRefriedBeans, walmart, 150, 16.0, uOz),
            purchaseOption(
            ...
            purchaseOption("00000000-0000-0000-0005-000000000013", iNatureSeasons, walmart, 428, 7.5, uOz),
        )
        .forEach { foodItemRepository.savePurchaseOption(it) }
    ...
    fun req(idString: String, item: FoodItem, qty: Double, unit: UnitModel) =
        FoodItemRequirement(
            id = Uuid.parse(idString),
            measurement =
                ItemMeasurement(foodItemId = item.id, unitId = unit.id, quantity = qty),
        )
    ...
    mealPlanRepository.addPlan(
        ScheduledMeal(
            ...
            time = LocalTime(8, 0),
            mealType = RecipeMealType.Breakfast,
            source = MealSource.PrePlannedMeal(rPancakes.id),
            peopleCount = 4,
        )
    )
    ...
    mealPlanRepository.addPlan(
        ScheduledMeal(
            ...
            time = LocalTime(18, 0),
            mealType = RecipeMealType.Dinner,
            source = MealSource.PrePlannedMeal(rEnchiladas.id),
            peopleCount = 6,
        )
    )
  }

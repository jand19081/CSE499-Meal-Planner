...
class RecipesViewModel(
      ...
      combine(
            ...
            draft.requirementGroups
                ...
                .map { req ->
                  ...
                  val unitAbbr =
                      allUnits.find { it.id == req.measurement.unitId }?.abbreviation ?: ""
  ...
  val uiState =
      combine(
            ...
            val warningsMap = allRecipes.associate { recipe ->
              recipe.id to
              ...
              filtered = filtered.filter { recipe ->
                ...
                groups.all { group ->
                  group.requirements.all { req ->
                    ...
                    val ingredientBridges = bridges.filter {
                      it.foodItemId == req.measurement.foodItemId
                    }
                    val pantryInReqUnit =
                        UnitConverter.convert(
                            ...
                            toUnitId =
                                req.measurement.unitId ?: subItem.preferredUnitId ?: Uuid.NIL,
                            allUnits = allUnits.associateBy { it.id },
  ...
  fun addIngredient(name: String) {
    viewModelScope.launch {
      ...
      val newIngredient =
          Ingredient(name = name, purchasableInfo = PurchasableInfo(categoryId = miscCategory.id))

  ...
  suspend fun initialize(
      ...
      kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        ...
        fun pkg(idString: String, item: FoodItem, store: Store, cents: Int, qty: Double, unit: UnitModel) = 
            Package(id = Uuid.parse(idString), foodItemId = item.id, storeId = store.id, priceCents = cents, quantity = qty, unitId = unit.id)
        ...
        // --- Bridges ---
        foodItemRepository.saveConversion(BridgeConversion(id = Uuid.parse("00000000-0000-0000-0006-000000000001"), foodItemId = iChicken.id, fromUnitId = uEach.id, fromQuantity = 1.0, toUnitId = uOz.id, toQuantity = 6.0))
        foodItemRepository.saveConversion(BridgeConversion(id = Uuid.parse("00000000-0000-0000-0006-000000000002"), foodItemId = iEggs.id, fromUnitId = uEach.id, fromQuantity = 12.0, toUnitId = uDozen.id, toQuantity = 1.0))
        foodItemRepository.saveConversion(BridgeConversion(id = Uuid.parse("00000000-0000-0000-0006-000000000003"), foodItemId = iCheese.id, fromUnitId = uCup.id, fromQuantity = 1.0, toUnitId = uOz.id, toQuantity = 4.0))
        foodItemRepository.saveConversion(BridgeConversion(id = Uuid.parse("00000000-0000-0000-0006-000000000004"), foodItemId = iButter.id, fromUnitId = uEach.id, fromQuantity = 1.0, toUnitId = uTbsp.id, toQuantity = 8.0))

        // --- Recipes ---
        fun req(idString: String, item: FoodItem, qty: Double, unit: UnitModel) = FoodItemRequirement(id = Uuid.parse(idString), foodItemId = item.id, quantity = qty, unitId = unit.id)
        ...
        mealPlanRepository.addPlan(ScheduledMeal(

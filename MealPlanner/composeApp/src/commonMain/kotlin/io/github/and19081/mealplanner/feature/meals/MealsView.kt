...
fun MealsView(
    ...
    val selectedMeal =
        uiState.groupedMeals.values.flatten().find { it.id.toString() == selectedMealId }
                ...
                Column(
                    ...
                    Row(horizontalArrangement = Arrangement.End, modifier = Modifier.fillMaxWidth()) {
                        ...
                        Button(
                            onClick = {
                                val found =
                                    (if (selectedType == "Recipe") allRecipes else allIngredients).find {
                                                ...
                                                FoodItemRequirement(
                                                    measurement =
                                                        ItemMeasurement(
                                                            ...
                                                            unitId =
                                                                if (selectedType == "Ingredient") unit?.id else null,
                                                        )
                                                )
                                    )
                                    isAdding = false
